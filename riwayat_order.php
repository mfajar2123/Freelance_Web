...
if(isset($_SESSION['user_id'])) {
    ...
    $query = "SELECT order_table.id_order, order_table.created_at, order_table.status, users.name 
              FROM order_table 
        ...
        <div class="order-item">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a href="halaman_pembayaran.php?order_id=<?= $orderId ?>" class="btn btn-details">Bayar</a>
                    <?php } else { ?>

                    <?php } ?>
                    <a href="order_details.php?id=<?= $orderId ?>" class="btn btn-details">Details</a>
                </div>
