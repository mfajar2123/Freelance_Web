												...
												if ($result->num_rows > 0) {
													...
													while ($row = $result->fetch_assoc()) {
														...
														<tr>
															...
															<td><img src="../assets/img/users/<?php echo $row['foto_profil']; ?>" alt="..." class="avatar-img rounded-circle" style="width: 50px; height: 50px;"></td>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="pekerjaan-datatables" class="display table table-striped table-hover">
												<thead>
													<tr>
														<th>No</th>
												...
												if ($result->num_rows > 0) {
													...
													while ($row = $result->fetch_assoc()) {
														...
														<tr>
															...
															<td>
															<a href="edit_pekerjaan.php?id_pekerjaan=<?php echo $row['id_pekerjaan']; ?>" class="btn btn-info btn-sm">Edit</a>
															<a href="delete_pekerjaan.php?id_pekerjaan=<?php echo $row['id_pekerjaan']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this job?')">Delete</a>
															</td>
														</tr>
												<?php
													}
												...
												<tbody>
													...
													?>
															<tr>
																...
																<td><?php echo $row['deskripsi_order']; ?></td>
																<td>
																	<button class="btn <?php echo $statusClass; ?> btn-sm"><?php echo $row['status']; ?></button>
																</td>
																<td>
																	<a href="edit_order.php?id_order=<?php echo $row['id_order']; ?>" class="btn btn-info btn-sm">Edit</a>
																	<a href="delete_order.php?id_order=<?php echo $row['id_order']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this job?')">Delete</a>
																</td>
															</tr>
													<?php
														}
